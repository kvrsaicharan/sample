...
var cookiesSchema = require('./schemas/cookies-schema');
...
var iasOptionsSchema = require('./schemas/ias-config-schema');
  ...
  validateXsApp: function(configuration, envDestinations, directory) {
    ...
    validator.addFormat('route-rules', function(route) {
      ...
      if (route.service && !process.env.SAAS_APPROUTER) {
        var serviceCredentials = businessServiceUtils.getCredentials(route.service, false);
